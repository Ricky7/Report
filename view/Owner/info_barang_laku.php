...
<div class="container" style="margin-top:70px;border:1px solid #8AC007">
	...
	<div class="row">
		...
		?>
			...
			<a class='btn btn-info btn-xs' href="#" ><span class="glyphicon glyphicon-edit"></span> Edit</a> <a class='btn btn-success btn-xs' href="info_barang.php?id=<?php echo $data['item_id'] ?>" ><span class="glyphicon glyphicon-ok"></span> Available</a>
