...
<div class="container" style="border:2px solid #8AC007;margin-bottom:20px;">
	<div class="row">
		<div id="title">
	...
	<div class="row">
		<?php
			...
			if(isset($_POST) && isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest'){
				...
				include("../../inc/pagination_conn.php");  //include config file
				...
				$results = $mysqli_conn->query("SELECT COUNT(*) FROM tb_info_item");
	...
	<div class="row">
		<div class="col-xs-12">
			<div align="center" style="margin-bottom:20px;margin-top:20px;">
				<?php echo paginate_function($item_per_page, $page_number, $get_total_rows[0], $total_pages); ?>
			</div>
			<?php
